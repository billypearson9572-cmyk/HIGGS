...
Ready to build one? [Book a free consultation](/contact) and we'll map it out together.`,
  },
  {
...
Want us to build it for you? [Have a look at our services](/services) or [book a free consultation](/contact).`,
  },
  {
...
Curious what we could automate for you? [Book a free consultation](/contact) and we'll find your biggest time-sinks.`,
  },
];
